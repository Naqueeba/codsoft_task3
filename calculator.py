...
btn_sub =tk.Button(root , text="-" , command=lambda: add_to_calcultion("-") , width=5 , font=("Arial" , 14))
btn_sub.grid(row=3 , column=4)

btn_mult =tk.Button(root , text="*" , command=lambda: add_to_calcultion("*") , width=5 , font=("Arial" , 14))
